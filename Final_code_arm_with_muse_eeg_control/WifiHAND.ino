...
// ✅ FIXED: Set a Static IP Address Inside the Correct Subnet
IPAddress local_IP(192,168,4,3);  // Pick an available IP in your network
IPAddress gateway(192,168,4,1);   // Correct gateway from `ipconfig`
